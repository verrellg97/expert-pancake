...
func (a inventoryService) AddOpeningStock(w http.ResponseWriter, r *http.Request) error {

	var req model.AddOpeningStockRequest
	...
	arg := db.AddOpeningStockTrxParams{
	...
	result, err := a.dbTrx.AddOpeningStockTrx(context.Background(), arg)
	if err != nil {
		return errors.NewServerError(model.AddNewOpeningStockError, err.Error())
	}
	...
	res := model.AddOpeningStockResponse{
