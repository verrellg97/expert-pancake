...
SELECT id, image_url, fullname, nickname, email, phone_number, created_at, updated_at FROM account.users
WHERE id = $1
`
...
WHERE
    id = $1
RETURNING id, image_url, fullname, nickname, email, phone_number, created_at, updated_at
`
